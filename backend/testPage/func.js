...
function rideRequest() {
    ...
    contract.events.RiderPicked({}).on('data', function(event){
        ...
        if (parseInt(event.returnValues.riderNumber)==number){
            ...
            document.getElementById("select").innerHTML = "Your rider should be here in : " + arrivalTime
        }
    })
    ...
    console.log("start: " + startLoc
                + " end: " + endLoc)
    document.getElementById("riderOut").innerHTML = "Starting from: "  
                                                    + startLoc
                                                    + "Destination: "
                                                    + endLoc;

    document.getElementById("select").innerHTML = "Waiting for Driver to Pickup"
